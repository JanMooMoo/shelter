...
function Notify(props) {
	return (
		<div className="notify">
			...
			<a href={"https://goerli.etherscan.io/tx/" + props.hash} title={props.hash} target = "blank" className="notifyHeader"> Transaction sent!</a> <span role="img" aria-labelledby="rocket">{props.tx}</span>
